...
public class SimpleRainController : MonoBehaviour
{
    ...
    private void InitializeDrawer(SimpleRainDrawerContainer dc)
    {
        ...
        dc.transform.localPosition = RainDropTools.GetSpawnLocalPos(this.transform, GetComponent<Camera>(), 0f, Variables.SpawnOffsetY);
    ...
    private void UpdateShader(SimpleRainDrawerContainer dc, int index)
    {
        ...
        Vector3 gforced = RainDropTools.GetGForcedScreenMovement(this.GetComponent<Camera>().transform, this.GForceVector);
